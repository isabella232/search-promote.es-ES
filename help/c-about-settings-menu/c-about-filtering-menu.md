...
Puede utilizar [!DNL Filtering Script] para cambiar el contenido de un documento Web antes de indexarlo.

Puede insertar etiquetas HTML, eliminar contenido irrelevante e incluso crear nuevos metadatos HTML basados en la URL de un documento, el tipo MIME y el contenido existente. La secuencia de comandos de filtrado es una secuencia de comandos Perl, que proporciona una potente gestión de cadenas y la flexibilidad de la coincidencia regular de expresiones. La secuencia de comandos de filtrado se utiliza con una secuencia de comandos de inicialización, una secuencia de comandos de finalización, una secuencia de comandos de máscaras URL y una URL de prueba.

La secuencia de comandos de filtrado se ejecuta cada vez que se lee un documento en el sitio web. La secuencia de comandos se ejecuta como un filtro estándar. En otras palabras, lee datos de STDIN, los transforma de alguna manera y escribe los resultados en STDOUT. Puede utilizar la secuencia de comandos de filtrado para imprimir mensajes de estado desde la secuencia de comandos de filtrado al registro de índice. Puede imprimir los mensajes en STDERR o mediante la subrutina `_search_debug_log()`.

Algunas opciones de diferencias GNU que puede utilizar en el modo **[!UICONTROL Expert (diff)]** de la página Secuencia de comandos de filtrado por etapas son las siguientes:
...
Además, puede escribir mensajes personalizados en el registro de índice mediante la subrutina `_search_debug_log()`, como en el siguiente ejemplo:
...
Estos mensajes aparecen con la palabra `DEBUG` como prefacio y no se registran como errores.

El siguiente es un ejemplo de filtrado. Los campos `<title>` de la página Web suelen comenzar con el nombre de la compañía. Aunque esta información es útil para la navegación del sitio, no es relevante para la búsqueda. Si los títulos de todas las páginas web de MegaCorp inicio con una cadena común, como por ejemplo:
...
Debe eliminar &quot; `MegaCorp --`&quot; del principio de cada título de documento y contar cada documento procesado con la secuencia de comandos de filtrado. Para ello, puede utilizar la siguiente secuencia de comandos:
...
| `$main::search_fields` | El valor contiene una lista separada por tabuladores de los campos de metadatos definidos en la cuenta. De forma predeterminada, el valor es:   `url title desc keys target body alt date charset language` Formulario obsoleto: `$main::ws_fields` |
...
* Todas las variables globales llevan el prefijo &quot;main::&quot; de la Área de nombres: `$main::doc_count = 0;`
* Todas las variables locales se declaran con &quot;my&quot;: `my $i = 0;`
* Las subrutinas se definen en la secuencia de comandos de inicialización. No necesitan una Área de nombres explícita de &quot;principal::&quot;: `sub my_sub {` `...`

   `}`

* Pruebe `$main::search_content_type` antes de realizar cambios en un archivo. La prueba puede ayudarle a evitar realizar cambios irresponsables en archivos binarios, como archivos SWF o archivos PDF:
...
* Si desea eliminar todo el texto de un documento, imprima un archivo STDOUT válido. Por ejemplo, para eliminar completamente todo el texto de un documento HTML, realice lo siguiente: `print "<html></html>";`

## Añadir una secuencia de comandos de filtrado {#task_0AB84FD1133F47F9AA069A79BEA13A22}

La secuencia de comandos de filtrado es una secuencia de comandos Perl que se ejecuta para cada documento que se descarga del sitio web.
...
1. (Opcional) En la página [!DNL Filtering Script], en el campo [!DNL Test URL], introduzca la dirección URL de un documento en el sitio Web.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>Permite la vista de la página. </p> </td> 
      </tr> 
      <tr> 
...
1. (Opcional) Vuelva a generar el índice del sitio escalonado si desea realizar una previsualización de los resultados.
   ...
   Consulte [Configuración de un índice incremental de un sitio Web escalonado](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0).
1. (Opcional) En la página [!DNL Filtering Script], realice una de las siguientes acciones:
...
Puede utilizar [!DNL Initialization Script] para cambiar el contenido de un documento Web antes de indexarlo.

Puede insertar etiquetas HTML, eliminar contenido irrelevante e incluso crear nuevos metadatos HTML basados en la URL de un documento, el tipo MIME y el contenido existente. La secuencia de comandos de inicialización es una secuencia de comandos Perl, que proporciona una potente gestión de cadenas y la flexibilidad de la coincidencia regular de expresiones. La secuencia de comandos de inicialización se utiliza con una secuencia de comandos de filtrado, una secuencia de comandos de finalización, una secuencia de comandos de máscaras URL y una URL de prueba.
...
Algunas opciones de diferencias GNU que puede utilizar en el modo **[!UICONTROL Expert (diff)]** de la página Script de inicialización escalonada incluyen lo siguiente:
...
## Añadir una secuencia de comandos de inicialización {#task_5A03B8D0C46E4674B7CE88203515803B}

La secuencia de comandos de inicialización es una secuencia de comandos Perl que se ejecuta una vez antes de indizar cualquier documentos.
...
1. (Opcional) En la página [!DNL Initialization Script], en el campo [!DNL Test URL], introduzca la dirección URL de un documento en el sitio Web.
   ...
   Consulte la tabla de opciones de filtrado en **Añadir una secuencia de comandos de filtrado**.
...
1. (Opcional) Vuelva a generar el índice del sitio escalonado si desea realizar una previsualización de los resultados.
   ...
   Consulte [Configuración de un índice incremental de un sitio Web escalonado](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0).
1. (Opcional) En la página [!DNL Initialization Script], realice una de las siguientes acciones:
...
Puede utilizar [!DNL Termination Script] para cambiar el contenido de un documento Web antes de indexarlo.

Puede insertar etiquetas HTML, eliminar contenido irrelevante e incluso crear nuevos metadatos HTML basados en la URL de un documento, el tipo MIME y el contenido existente. La secuencia de comandos de inicialización es una secuencia de comandos Perl, que proporciona una potente gestión de cadenas y la flexibilidad de la coincidencia regular de expresiones. La secuencia de comandos de finalización se utiliza con una secuencia de comandos de inicialización, una secuencia de comandos de filtrado, una secuencia de comandos de finalización, una secuencia de comandos de máscaras URL y una URL de prueba.
...
Algunas opciones de línea de comandos de diferf GNU que puede utilizar en modo **[!UICONTROL Expert (diff)]** en la página Secuencia de comandos de terminación en etapas incluyen lo siguiente:
...
## Añadir una secuencia de comandos de terminación {#task_F0CFB412871642CFBC88132889C5B6F9}
...
1. (Opcional) En la página [!DNL Termination Script], en el campo [!DNL Test URL], introduzca la dirección URL de un documento en el sitio Web.
   ...
   Al hacer clic en **[!UICONTROL Test]** no se actualiza ni se guarda la secuencia de comandos de finalización.
...
1. (Opcional) Vuelva a generar el índice del sitio escalonado si desea realizar una previsualización de los resultados.
   ...
   Consulte [Configuración de un índice incremental de un sitio Web escalonado](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0).
1. (Opcional) En la página [!DNL Termination Script], realice una de las siguientes acciones:
...
Con el filtrado, puede cambiar el contenido de un documento web antes de indexarlo. Puede insertar etiquetas HTML, eliminar contenido irrelevante e incluso crear nuevos metadatos HTML basados en la URL de un documento, el tipo MIME y el contenido existente. La secuencia de comandos de máscaras URL es una secuencia de comandos Perl que proporciona una potente gestión de cadenas y la flexibilidad de la coincidencia de expresiones normal.

Para cambiar el contenido de los documentos que solo existen en una parte específica del sitio web, puede especificar incluir máscaras URL, excluir máscaras URL o ambas, para definir las páginas correspondientes.

Si desea cambiar solo los documentos en `"https://www.mysite.com/faqs/"`, puede utilizar el siguiente conjunto de máscaras:
...
También puede utilizar la expresión regular en un script de máscara de URL, como en el ejemplo siguiente:
...
Las máscaras URL con secuencias de comandos se consideran en el orden en que se introdujeron en el campo [!DNL URL Masks]. Cuando una dirección URL de documento coincide con una máscara, ese documento se incluye o excluye en función del tipo de máscara. Si la dirección URL de un documento no coincide con ninguna máscara de dirección URL, el documento se incluye solo si su tipo MIME es &quot;text/html&quot;. Se excluyen todos los demás tipos MIME.

## Añadir una secuencia de comandos de máscara de URL {#task_D18F2A496C1C45C997B5DA650AAF5D59}

Especifique la URL, que incluye máscaras y que excluye máscaras para cambiar el contenido de documentos que solo existen en una parte específica del sitio web.
...
1. (Opcional) En la página [!DNL URL Masks], en el campo [!DNL Test URL], introduzca una dirección URL de un documento en el sitio Web y, a continuación, haga clic en **[!UICONTROL Test]** para probar la dirección URL con las secuencias de comandos y máscaras de filtrado.
   ...
   Al hacer clic en **[!UICONTROL Test]** no se actualiza ni se guarda la secuencia de comandos.
1. En el campo [!DNL URL Masks], introduzca una máscara URL por línea.
1. (Opcional) Haga clic en **[!UICONTROL Check Syntax]** para realizar una comprobación rápida de la sintaxis de las máscaras URL ejecutando las secuencias de comandos de filtrado, inicialización y finalización.
...
1. (Opcional) Vuelva a generar el índice del sitio escalonado si desea realizar una previsualización de los resultados.
   ...
   Consulte [Configuración de un índice incremental de un sitio Web escalonado](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0).
1. (Opcional) En la página [!DNL URL Masks], realice una de las siguientes acciones:
...
1. (Opcional) Vuelva a generar el índice del sitio escalonado si desea realizar una previsualización de los resultados.
   ...
   Consulte [Configuración de un índice incremental de un sitio Web escalonado](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0).
1. (Opcional) En la página [!DNL Content Types], realice una de las siguientes acciones:
