---
description: Utilice el menú Informes para ver o restablecer los informes de las consultas de búsqueda de los clientes.
seo-description: Utilice el menú Informes para ver o restablecer los informes de las consultas de búsqueda de los clientes.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>El número de búsquedas en las que los visitantes buscaron una sola palabra o una frase completa. </p> <p>Contiene la frase o palabra ingresada por cada cliente. Cada frase o palabra está hipervinculada para que pueda comprobar fácilmente sus resultados de búsqueda reales. Esta columna también puede contener el valor de la consulta en blanco, que indica que un cliente hizo clic en <span class="uicontrol"> Buscar</span> sin escribir ningún término de búsqueda. </p> </td> 
  </tr> 
  <tr> 
...
1. (Opcional) En la tabla, debajo de la [!DNL Words] columna, haga clic en una palabra para abrir la [!DNL Live Simulator for Today] página.
...
Consulte [Acerca de los grupos](../c-about-settings-menu/c-about-adobe-analytics-menu.md#concept_1A51AEC5D40E459B813E7891D64B1BAE)de informes de Adobe Analytics.
...
La [!DNL Staged Adobe Analytics Terms Report] página y la [!DNL Staged Adobe Analytics Report Suites] página muestran la siguiente información en una tabla:
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Identifica el nombre del grupo de informes de Adobe Analytics. </p> <p>Consulte <a href="../c-about-settings-menu/c-about-adobe-analytics-menu.md#task_6DE17305EA7146DA8C30FF8FDF68A3C0" type="task" format="dita" scope="local"> Adición de un grupo</a>de informes de Adobe Analytics. </p> <p>Consulte <a href="../c-about-settings-menu/c-about-adobe-analytics-menu.md#task_360904CCBBB140238ADA036C3CC07664" type="task" format="dita" scope="local"> Edición de las métricas de Adobe Analytics de un grupo</a>de informes. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Tipo de informe (elemento Adobe Analytics) </p> </td> 
   <td colname="col2"> <p>El elemento Adobe Analytics, el valor de clasificación o ambos que se utilizan en la solicitud de grupo de informes. </p> <p>Consulte <a href="../c-about-settings-menu/c-about-adobe-analytics-menu.md#task_360904CCBBB140238ADA036C3CC07664" type="task" format="dita" scope="local"> Edición de las métricas de Adobe Analytics de un grupo</a>de informes. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Campo de referencia cruzada </p> </td> 
   <td colname="col2"> <p>Campo de metadatos opcional, cuyos valores se utilizan como "claves" de búsqueda en el grupo de informes. </p> <p>Consulte <a href="../c-about-settings-menu/c-about-adobe-analytics-menu.md#task_360904CCBBB140238ADA036C3CC07664" type="task" format="dita" scope="local"> Edición de las métricas de Adobe Analytics de un grupo</a>de informes. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Acciones </p> </td> 
   <td colname="col2"> <p>Permite obtener una vista previa de la copia más reciente de los datos del grupo de informes. </p> <p>Consulte <a href="../c-about-settings-menu/c-about-adobe-analytics-menu.md#task_735CDCC1D8174B7B9F5B8E0AFA5F0CA0" type="task" format="dita" scope="local"> Vista previa de datos</a>de Adobe Analytics. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
## Visualización del informe de solicitudes de búsqueda o del informe de solicitudes de contenido {#task_4C6EFB4D51474FC1BDE4326D1A726ECC}

Puede ver el [!DNL Search Requests Report] para ver el número de solicitudes de búsqueda durante un período de tiempo específico. También puede ver el [!DNL Content Requests Report] para ver el número de solicitudes de contenido durante un período de tiempo específico.
...
1. En la lista desplegable de la página del informe, **[!UICONTROL Period]** seleccione el período de tiempo que desee incluir en el informe.
1. En la lista **[!UICONTROL Chart Type]** desplegable, seleccione una de las siguientes opciones según el informe seleccionado:
...
1. En la lista **[!UICONTROL Chart Style]** desplegable, seleccione cómo desea que se representen los datos en el informe.
...
1. En el menú de producto, haga clic en **[!UICONTROL Reports]** > **[!UICONTROL Index Size]**.
1. En la lista desplegable de la página del informe, **[!UICONTROL Period]** seleccione el período de tiempo que desee incluir en el informe.
1. En la lista **[!UICONTROL Chart Style]** desplegable, seleccione cómo desea que se representen los datos en el informe.

## Visualización del informe Rendimiento del rastreo o del informe Rendimiento del rastreo por etapas {#task_60ED9FD9769C48B1B5EEE7099B1D1899}
...
1. En el menú del producto, realice una de las siguientes acciones:
   ...
   + Haga clic **[!UICONTROL Reports]** > **[!UICONTROL Crawl Performance]**.
      ...
      En la lista desplegable de la página del informe, **[!UICONTROL Crawl Ending]** seleccione el período de tiempo que desee incluir en el informe.

   + Haga clic **[!UICONTROL Reports]** > **[!UICONTROL Staged Crawl Performance]**.

      En la lista desplegable de la página del informe, **[!UICONTROL Staged Crawl Ending]** seleccione el período de tiempo que desee incluir en el informe.

1. En la lista **[!UICONTROL Metric]** desplegable, seleccione una de las siguientes métricas:
...
1. En la lista **[!UICONTROL Chart Style]** desplegable, seleccione cómo desea que se representen los datos en el informe. Puede seleccionar **[!UICONTROL Bars]** o **[!UICONTROL Area]**.
1. En la lista **[!UICONTROL Chart Type]** desplegable, elija el nivel de índice sobre el que desea crear el informe. Puede seleccionar **[!UICONTROL Full]**, **[!UICONTROL Incremental]** o **[!UICONTROL Full & Incremental]**.
...
Solo se muestran los cambios que aparecen debajo [!DNL History] . Los cambios se enumeran en orden cronológico inverso. Cada entrada muestra la página que se cambió, su número de versión en Historial, la dirección de correo electrónico del usuario que realizó los cambios, la hora del cambio y si el cambio fue un guardado o la configuración de la página se activó.

Consulte [Acerca del ensayo](../c-about-staging.md#concept_08B8F3CA1F4241108F14BA7FC7806CA7).

1. En el menú de producto, haga clic en **[!UICONTROL Reports]** > **[!UICONTROL Change Log]**.
1. En la [!DNL Change Log] página, utilice las opciones de navegación y visualización en la parte superior e inferior de la página para ver la información del registro.
