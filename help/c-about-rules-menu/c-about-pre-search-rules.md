...
## Condiciones de las reglas de búsqueda previa {#section_B5568ADEB28546A280720309498B045D}
...
1. En la [!DNL Pre-Search Rules] página, haga clic en **[!UICONTROL Add New Rule]**.
1. En el [!DNL Name] campo, escriba el nombre de la nueva regla de limpieza de consultas.
1. En la [!DNL Add Pre-Search Rule] página, utilice las listas desplegables y los campos de texto para crear la consulta.
...
Puede editar las reglas de búsqueda previa existentes que haya agregado a la [!DNL Pre-Search Rules] página.

**Para editar una regla de búsqueda previa**

1. En el menú de producto, haga clic en **[!UICONTROL Rules]** > **[!UICONTROL Pre-Search Rules]**.
1. En la [!DNL Pre-Search Rules] página, debajo de la **[!UICONTROL Actions]** columna de la tabla, haga clic en **[!UICONTROL Edit]** para la regla asociada que desee editar.
1. En la [!DNL Edit Pre-Search Rule] página, utilice las listas desplegables y los campos de texto para crear la consulta.

   Consulte la tabla de opciones en [Adición de una nueva regla](../c-about-rules-menu/c-about-pre-search-rules.md#task_182B95918462490D8BDA7F16A81CAC11)de búsqueda previa.
...
1. En el menú de producto, haga clic en **[!UICONTROL Rules]** > **[!UICONTROL Pre-Search Rules]**.
1. En la [!DNL Pre-Search Rules] página, debajo de la **[!UICONTROL Actions]** columna de la tabla, haga clic en **[!UICONTROL Delete]** para la regla asociada que desee eliminar.
