---
description: Puede utilizar menús para personalizar la capa de presentación.
seo-description: Puede utilizar menús para personalizar la capa de presentación.
seo-title: Acerca de los menús
solution: Target
subtopic: Navigation
...
Puede utilizar menús para personalizar la capa de presentación.
...
1. En la [!DNL Add Menu] página, configure las opciones que desee.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>Especifica el número de elementos de un menú. Al cambiar esta configuración, se agregan o eliminan campos del formulario. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>El valor del elemento depende del tipo de menú que haya definido. </p> 
        <ul id="ul_2F14E6AA673640578A2D5161FD9D13EF"> 
        <li id="li_5017EC6E4ACB4B8E99E0AA61CBAAFFAE"> Tipo de menú Ordenar <p>Identifica por qué debe ordenarse el elemento seleccionado en el menú. Los elementos seleccionados se rellenan con campos de metadatos que se pueden ordenar. </p> <p>Para un solo elemento puede ordenar por tres campos de metadatos. La ordenación se realiza en el orden especificado. </p> </li> 
        <li id="li_CC6BAFBF969C4367A71B55F08E0758D1"> Tipo de menú de recuento <p>Permite especificar el número de resultados que desea devolver cuando el cliente seleccione este elemento de menú. </p> </li> 
        </ul> </td> 
      </tr> 
      <tr> 
