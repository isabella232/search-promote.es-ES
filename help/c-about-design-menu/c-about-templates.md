...
Puede reducir el peso de página de una plantilla de presentación marcando la casilla de verificación correspondiente de la plantilla **[!UICONTROL Minimize]** en la tabla de la plantilla. Al reducir el peso de página de la plantilla, se minimiza dinámicamente JavaScript y CSS en línea. También puede eliminar espacios en blanco redundantes en el HTML. Minimizar el peso de página de la plantilla de presentación puede ayudar a proporcionar los resultados de búsqueda más rápido.

Para previsualización del aspecto de la plantilla minimizada, haga clic en la lista desplegable situada junto al nombre del archivo y, a continuación, haga clic en **[!UICONTROL Preview minimized]**. Si minimiza la plantilla de presentación principal, asegúrese de habilitar la minimización de plantillas incluidas (con la etiqueta `guided-include`) porque esta opción no es heredable.
...
Consulte [Acerca de las reglas de postbúsqueda](../c-about-rules-menu/c-about-post-search-rules.md#concept_AF6ADFCC0ADF4A788003964939917FDE).
...
Cuando utilice varias plantillas de presentación, asegúrese de indicar qué plantilla desea que aparezcan inicialmente los resultados de búsqueda. Puede hacerlo mediante la columna **[!UICONTROL Default]** de la tabla Plantillas.
...
De forma predeterminada, su cuenta está configurada para utilizar plantillas de transporte XML. Sin embargo, si prefiere utilizar JSON para pasar sus datos a la búsqueda guiada, póngase en contacto con el consultor de Adobe, quien puede ayudarle.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Este conjunto de etiquetas se envuelve en torno a cada resultado de búsqueda, de modo que la búsqueda guiada reconoce dónde inicio y termina el contenido de un único resultado de búsqueda. </p> <p> <b>Ejemplo</b> </p> <p> <code> &nbsp;&nbsp;&nbsp;&nbsp;&lt;results&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;search-results&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;result&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Esta etiqueta le permite recorrer en bucle cada elemento en una lista de varios valores para un único resultado. Utilice la etiqueta solo dentro de un resultado. Su principal función es permitir iterar los atributos que pertenecen a un campo de resultado. </p> <p> <b>Ejemplo</b> </p> <p> <code> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;results&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;search-results&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;result&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;index&gt;&lt;search-index&nbsp;/&gt;&lt;/index&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;loc&gt;&lt;search-url&nbsp;/&gt;&lt;/loc&gt; 
...
## Añadir un nuevo archivo de plantilla de transporte o presentación {#task_73199757B6E748CAA604902FF913F012}
...
1. En el cuadro de diálogo [!DNL Add Template], configure las opciones que desee.
   ...
   Consulte también [Edición de una presentación o una plantilla de transporte](../c-about-design-menu/c-about-templates.md#task_800E0E2265C34C028C92FEB5A1243EC3).
...
Puede utilizar el Editor de plantillas para vista y edición del contenido de los archivos de plantillas de presentación y transporte.
...
Puede editar y probar las plantillas de transporte y presentación por etapas, mientras que los visitantes del sitio web siguen utilizando las versiones activas de las plantillas. La plantilla de ensayo se prueba con la versión de ensayo de la dirección URL del dominio de búsqueda. Por ejemplo, puede probar la plantilla de transporte escalonado ejecutando una consulta escalonada ( `sp_staged=1`) con `sp_t` que esté configurada en el nombre de la plantilla de transporte. Cuando esté satisfecho con la apariencia del diseño, puede utilizar **[!UICONTROL Push Live]** desde el editor de plantillas para insertar la plantilla en directo. Una vez que la plantilla está activa, los visitantes del sitio empiezan a utilizarla.
...
Consulte [Añadir un nuevo archivo de plantilla de transporte o presentación](../c-about-design-menu/c-about-templates.md#task_73199757B6E748CAA604902FF913F012).
...
1. En el menú del producto, haga clic en **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. En la página [!DNL Templates], en la lista desplegable junto al nombre de la plantilla cuyo nombre desee cambiar, haga clic en **[!UICONTROL Rename]**.
...
1. En el menú del producto, haga clic en **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. En la página [!DNL Templates], en la lista desplegable al lado del nombre de la plantilla que desea eliminar, haga clic en **[!UICONTROL Delete]**.
...
Puede utilizar **[!UICONTROL Preview minimized]** para ver el aspecto que tendría el peso de página reducido de una plantilla de presentación si decide minimizarla.
...
Debe tener una plantilla ya agregada para la previsualización minimizada de la plantilla.

Consulte [Añadir un nuevo archivo de plantilla de transporte o presentación](../c-about-design-menu/c-about-templates.md#task_73199757B6E748CAA604902FF913F012)

Puede previsualización del código XML de un archivo de plantilla de transporte.
...
**Previsualización de la plantilla de presentación minimizada**
...
Puede reducir el peso de página de una plantilla de presentación mediante la opción **[!UICONTROL Minimize]** de la tabla de plantillas.
...
Al reducir el peso de página de la plantilla, se minimiza dinámicamente JavaScript y CSS en línea. También puede eliminar espacios en blanco redundantes en el HTML. Minimizar el peso de página de la plantilla de presentación puede ayudar a proporcionar los resultados de búsqueda más rápido.

También puede previsualización del aspecto de la plantilla de presentación minimizada mediante **[!UICONTROL Preview minimized]**.
...
## Configuración del archivo de plantilla de presentación predeterminado para utilizarlo en su sitio Web {#task_C1E8CE817E4D43E096167A347C54DD53}
...
1. En el menú del producto, haga clic en **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. En la página [!DNL Templates], en la columna [!DNL Default], haga clic en el botón de opción del archivo de plantilla de presentación correspondiente que desee que se muestre como predeterminado.
...
Debe tener una plantilla de transporte ya agregada para la previsualización del XML de la plantilla.

Consulte [Añadir un nuevo archivo de plantilla de transporte o presentación](../c-about-design-menu/c-about-templates.md#task_73199757B6E748CAA604902FF913F012).

Puede previsualización de archivos de plantilla de presentación minimizados para vista de su peso de página reducido.

Consulte [Vista previa de la plantilla de presentación minimizada](../c-about-design-menu/c-about-templates.md#task_1757B6207CC74221AE4BFFE5674D320B).

**Previsualización del XML de un archivo de plantilla de transporte**
